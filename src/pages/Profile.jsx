    ...
    <div className="p-4 space-y-4 pb-28">
      ...
      <div className="flex rounded-2xl p-1 gap-1" style={{ background: 'rgba(255,255,255,0.05)' }}>
        <button
          ...
          className={`flex-1 py-2.5 rounded-xl text-xs font-black transition-all duration-200 flex items-center justify-center gap-1.5 ${activeTab === 'profile' ? 'text-white' : 'text-white/35'}`}
          style={activeTab === 'profile' ? { background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.12)' } : {}}
        >
        ...
        <button
          ...
          className={`flex-1 py-2.5 rounded-xl text-xs font-black transition-all duration-200 flex items-center justify-center gap-1.5 ${activeTab === 'alerts' ? 'text-white' : 'text-white/35'}`}
          style={activeTab === 'alerts' ? { background: 'rgba(239,68,68,0.15)', border: '1px solid rgba(239,68,68,0.3)' } : {}}
        >
      ...
      {activeTab === 'alerts' && (
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}
          className="rounded-2xl p-4" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)' }}>
          <AlertsPanel />
        </motion.div>
      )}
