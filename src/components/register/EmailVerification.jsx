...
// Simulated OTP — in production replace with real email backend
...
export default function EmailVerification({ email, onVerified, onBack }) {
  ...
  return (
    ...
    >
      ...
      <div>
        <h3 className="text-lg font-black text-white">אימות כתובת מייל</h3>
      ...
      <p className="text-[10px] text-white/20">
        🧪 לדמו: הקוד הוא <span className="text-white/40 font-bold">654321</span>
      </p>
