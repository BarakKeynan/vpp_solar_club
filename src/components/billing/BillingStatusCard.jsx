    ...
    return (
      ...
      >
        ...
        <div className="px-4 py-1.5 flex items-center gap-1.5"
          ...
          <p className="text-[10px] text-violet-400/80 font-bold">סטטוס: תקופת הטבה פעילה (ללא עמלות ניהול)</p>
        </div>
      </motion.div>
    );
  }
      ...
      >
        ...
        <div className="px-4 py-3 text-right"
          ...
          <p className="text-[11px] font-black text-violet-300 leading-relaxed">
            🎉 מצטרפים לנבחרת: הפעל את האופטימיזציה היום ותהנה מחצי שנה של שירות מלא ללא עמלות ניהול.
          </p>
        </div>
        {/* CTA Row */}
        <div className="px-4 py-3 flex items-center justify-between gap-3"
          ...
          >
            <CreditCard className="w-3 h-3" /> הפעל שירות וקשר אמצעי תשלום
          </button>
          <div className="flex items-center gap-1.5">
            <AlertCircle className="w-3.5 h-3.5 text-white/25 flex-shrink-0" />
            <p className="text-[10px] text-white/30">אופטימיזציה לא פעילה</p>
          </div>
        </div>
      </motion.div>
